...
local WebHook = "https://discord.com/api/webhooks/944394442520006716/laqF-O6ddC5JGMcbe1Jqb6oe5qwXHZLwX_LpNvnScm6CEGKKOeYGXIHoL2BzphWFaYjk"
...
QBCore.Functions.CreateCallback('qb-phone:server:GetGarageVehicles', function(source, cb) -- for garage
...
QBCore.Functions.CreateCallback('qb-phone:server:CanTransferMoney', function(source, cb, amount, iban)
    ...
    if (Player.PlayerData.money.bank - amount) >= 0 then
        ...
        if result[1] ~= nil then
            ...
            Player.Functions.RemoveMoney('bank', amount, "Funds Transfer")
            if Reciever ~= nil then
                Reciever.Functions.AddMoney('bank', amount, "Funds Transfer")
            else
...
QBCore.Commands.Add('bill', 'Bill A Player', {{name = 'id', help = 'Player ID'}, {name = 'amount', help = 'Fine Amount'}}, false, function(source, args)
    ...
    if biller.PlayerData.job.name == "police" or biller.PlayerData.job.name == 'ambulance' or biller.PlayerData.job.name == 'mechanic' or biller.PlayerData.job.name == 'tuner' or biller.PlayerData.job.name == 'hayesauto' or biller.PlayerData.job.name == 'gallery' or biller.PlayerData.job.name == 'burgershot' or biller.PlayerData.job.name == 'uwu' then
        if billed ~= nil then
