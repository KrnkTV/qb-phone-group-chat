...
RegisterNetEvent('qb-phone:client:TriggerPhoneHack', function(src)
    QBCore.Functions.Progressbar("hack_gate", "Plugging in the usb...", math.random(5000, 10000), false, true, {
        ...
        local success = exports['qb-lock']:StartLockPickCircle(1,40)
        if success then
            TriggerServerEvent("QBCore:Server:RemoveItem", "phonedongle", 1)
            TriggerEvent('inventory:client:ItemBox', QBCore.Shared.Items["phonedongle"], "remove")
